...
impl TransmissionService {
    ...
    */
    pub fn torrent_add(tor: String) -> Result<TransmissionResponse, Error> {
        Self::json_to_response(CliClient::run_command(format!("transmission-remote -j -a {}", tor)))
    }

    pub fn torrent_remove(tor_id: String) -> Result<TransmissionResponse, Error> {
    ...
    pub fn torrent_info(tor_id: String) -> Result<TransmissionResponse, Error> {
        Self::json_to_response(CliClient::run_command(format!("transmission-remote -j -t {} -i", tor_id)))
    }
    //
    // pub fn torrent_files(tor_id: String) -> Result<TransmissionResponse, Error> {
    //     Self::json_to_response(CliClient::run_command(format!("transmission-remote -j -t {} -f", tor_id)))
    // }
    //
    // pub fn torrent_peers(tor_id: String) -> Result<TransmissionResponse, Error> {
    //     Self::json_to_response(CliClient::run_command(format!("transmission-remote -j -t {} -ip", tor_id)))
    // }
    //
    // pub fn torrent_trackers(tor_id: String) -> Result<TransmissionResponse, Error> {
    ...
    fn json_to_response(source: Vec<String>) -> Result<TransmissionResponse, Error> {
